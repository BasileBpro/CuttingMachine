...
namespace Projet
{
    ...
    public partial class Form4 : Form
    {
        ...
        {
            string s = textBox4.Text, s1 = textBox1.Text, s2 = textBox2.Text, s3 = textBox3.Text;
            ...
            if(int.TryParse(s, out i) && int.TryParse(s1, out i1) && int.TryParse(s2, out i2) && int.TryParse(s3, out i3))
            {
                ...
                l.Add(new Point(Form1.longueurPanel *(i+i2) / Form1.Longueur, Form1.largeurPanel * (i1+i3) / Form1.Largeur));
                l.Add(new Point(Form1.longueurPanel * i / Form1.Longueur, Form1.largeurPanel * (i1+i3) / Form1.Largeur));
            }
