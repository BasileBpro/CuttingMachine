...
namespace Projet
{
    public partial class Form6 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            if (int.TryParse(s, out i) && int.TryParse(s1, out i1) && int.TryParse(s2, out i2) && int.TryParse(s3, out i3) && int.TryParse(s4, out i4) && int.TryParse(s5, out i5))
            {
                ...
                l.Add(new Point(Form1.longueurPanel * i4 / Form1.Longueur, Form1.largeurPanel * i5 / Form1.Largeur));
            }
